...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "就绪"),
        ("Established", "已建立"),
        ("connecting_status", "正在接入 专属VIP网络..."),
        ("Enable service", "允许服务"),
        ("Start service", "启动服务"),
        ...
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的桌面, 请给予 RD \"辅助功能\" 权限。"),
        ("config_screen", "为了能够远程访问你的桌面, 请给予 RD \"屏幕录制\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("setup_server_tip", "VIP服务器专属版本，请勿与其它定制版本混肴使用，否则无法连接"),
